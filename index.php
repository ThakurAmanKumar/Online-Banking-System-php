...
<p>And finally, proceed for Internet Banking Registration to create your internet banking account.
    ...
    <div id="aboutus" class="about"><span>About Us</span><br><br>
        <p>Bank of Janakpur is a trusted financial institution dedicated to empowering individuals, businesses, and communities through innovative and reliable banking services. Founded with a commitment to customer satisfaction and financial inclusion, we strive to make banking accessible, secure, and convenient for everyone. We blend traditional banking values with modern financial technology to offer a wide range of services—from personal and business banking to digital solutions tailored for the evolving needs of our clients. At Bank of Janakpur, we believe in building long-term relationships based on trust, transparency, and excellence. Our mission is to be more than just a bank—we aim to be your lifelong financial partner.</p>
    </div>
